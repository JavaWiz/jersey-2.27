...
public class CustomLoggingFilter implements ContainerRequestFilter, ContainerResponseFilter {
	...
	public void filter(ContainerRequestContext ctx) throws IOException {
		...
		log.debug("Application path : {}",ctx.getUriInfo().getAbsolutePath());
		log.debug("Entering in Resource : /{} ", ctx.getUriInfo().getPath());
		...
		logQueryParameters(ctx);
        logMethodAnnotations();
        logRequestHeader(ctx);
        
      //log entity stream...
        String entity = readEntityStream(ctx);
